    ...
    char **argv)
{
  ...
  for (i = 0 ; hmac_sha1_tests[i].key_len > 0 ; i++)
    {
      xchar_t *name = g_strdup_printf ("/hmac/sha1-%d", i + 1);
  ...
  for (i = 0 ; hmac_sha256_tests[i].key_len > 0 ; i++)
    {
      xchar_t *name = g_strdup_printf ("/hmac/sha256-%d", i + 1);
  ...
  for (i = 0 ; hmac_sha384_tests[i].key_len > 0 ; i++)
    {
      xchar_t *name = g_strdup_printf ("/hmac/sha384-%d", i + 1);
  ...
  for (i = 0 ; hmac_sha512_tests[i].key_len > 0 ; i++)
    {
      xchar_t *name = g_strdup_printf ("/hmac/sha512-%d", i + 1);
  ...
  for (i = 0 ; hmac_md5_tests[i].key_len > 0 ; i++)
    {
      xchar_t *name = g_strdup_printf ("/hmac/md5-%d", i + 1);
