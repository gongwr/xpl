...
#define PACKTAB_UINT8 xuint8_t
#define PACKTAB_UINT16 xuint16_t
#define PACKTAB_UINT32 xuint32_t

/*
  generated by packtab.c version 3

  use XPL_GET_MIRRORING_DELTA(key) to access your table
...
#define XPL_GET_MIRRORING_DELTA(x) \
	((x) >= 0x10000 ? 0 :  \
	MirLev3[((x) & 0x03) + \
	MirLev2[((x) >> 2 & 0x03) + \
	MirLev1[((x) >> 4 & 0x0f) + \
...
#define XPL_GET_MIRRORING(x) ((x) + XPL_GET_MIRRORING_DELTA(x))
