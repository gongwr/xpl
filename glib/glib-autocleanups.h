...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xerror_t, g_error_free)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xlist_t, g_list_free)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xvariant_t, g_variant_unref)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xvariant_type_t, g_variant_type_free)
