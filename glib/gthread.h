...
XPL_AVAILABLE_IN_2_32
GThread *       g_thread_new                    (const xchar_t    *name,
                                                 GThreadFunc     func,
                                                 xpointer_t        data);
XPL_AVAILABLE_IN_2_32
GThread *       g_thread_try_new                (const xchar_t    *name,
                                                 GThreadFunc     func,
                                                 xpointer_t        data,
                                                 xerror_t        **error);
XPL_AVAILABLE_IN_ALL
...
XPL_AVAILABLE_IN_ALL
void            g_thread_exit                   (xpointer_t        retval);
XPL_AVAILABLE_IN_ALL
xpointer_t        g_thread_join                   (GThread        *thread);
XPL_AVAILABLE_IN_ALL
...
XPL_AVAILABLE_IN_ALL
xboolean_t        g_mutex_trylock                 (GMutex         *mutex);
XPL_AVAILABLE_IN_ALL
...
XPL_AVAILABLE_IN_2_32
xboolean_t        g_cond_wait_until               (GCond          *cond,
                                                 GMutex         *mutex,
                                                 gint64          end_time);
 ...
 *
 * static xchar_t *
 * my_object_get_data (MyObject *self, xuint_t index)
 * {
 ...
 *
 * static void
 * my_object_set_data (MyObject *self, xuint_t index, xpointer_t data)
 * {
