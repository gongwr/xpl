 ...
 * of #GSList over #xlist_t (doubly linked list) is that they are lighter
 ...
 * from @free_func:
 * |[<!-- language="C" -->
 * GSList *list_of_owned_things = …;  /<!-- -->* (transfer full) (element-type xobject_t) *<!-- -->/
 ...
 */
GSList*
g_slist_copy_deep (GSList *list, GCopyFunc func, xpointer_t user_data)
{
