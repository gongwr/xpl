...
static void test_iface_default_init (TestIfaceClass *iface, xpointer_t class_data);
...
G_DEFINE_DYNAMIC_TYPE_EXTENDED(DynamicObject, dynamic_object, XTYPE_OBJECT, 0,
