 ...
 * @include: gio/gio.h
 * @see_also: #xinput_stream_t, #GDataInputStream, #GSeekable
 *
...
static xboolean_t   g_file_input_stream_seekable_can_seek      (GSeekable            *seekable);
static xboolean_t   g_file_input_stream_seekable_seek          (GSeekable            *seekable,
							      goffset               offset,
							      GSeekType             type,
							      xcancellable_t         *cancellable,
							      xerror_t              **error);
static xboolean_t   g_file_input_stream_seekable_can_truncate  (GSeekable            *seekable);
static xboolean_t   g_file_input_stream_seekable_truncate      (GSeekable            *seekable,
							      goffset               offset,
							      xcancellable_t         *cancellable,
							      xerror_t              **error);
...
G_DEFINE_TYPE_WITH_CODE (GFileInputStream, g_file_input_stream, XTYPE_INPUT_STREAM,
