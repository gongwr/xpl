...
static xchar_t *g_inet_socket_address_connectable_to_string  (GSocketConnectable      *connectable);

G_DEFINE_TYPE_WITH_CODE (GInetSocketAddress, g_inet_socket_address, XTYPE_SOCKET_ADDRESS,
...
g_inet_socket_address_new (xinet_address_t *address,
                           guint16       port)
{
  return g_object_new (XTYPE_INET_SOCKET_ADDRESS,
		       "address", address,
		       "port", port,
		       NULL);
}
 ...
 * @address: a %XSOCKET_FAMILY_IPV6 #GInetSocketAddress
 *
