...
test_unix_socket_address_construct (void)
{
  ...
  a = g_object_new (XTYPE_UNIX_SOCKET_ADDRESS, NULL);
   ...
   */
  a = g_object_new (XTYPE_UNIX_SOCKET_ADDRESS, "address-type", G_UNIX_SOCKET_ADDRESS_PATH, NULL);
  g_assert_cmpint (g_unix_socket_address_get_address_type (a), ==, G_UNIX_SOCKET_ADDRESS_PATH);
  g_object_unref (a);

  a = g_object_new (XTYPE_UNIX_SOCKET_ADDRESS, "abstract", FALSE, NULL);
  g_assert_cmpint (g_unix_socket_address_get_address_type (a), ==, G_UNIX_SOCKET_ADDRESS_PATH);
  g_object_unref (a);

  a = g_object_new (XTYPE_UNIX_SOCKET_ADDRESS,
                    "abstract", FALSE,
