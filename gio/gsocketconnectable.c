 ...
 * xsocket_connectable_enumerate() to get a #GSocketAddressEnumerator
...
G_DEFINE_INTERFACE (GSocketConnectable, xsocket_connectable, XTYPE_OBJECT)

static void
xsocket_connectable_default_init (GSocketConnectableInterface *iface)
{
}
...
xsocket_connectable_enumerate (GSocketConnectable *connectable)
{
 ...
 */
GSocketAddressEnumerator *
xsocket_connectable_proxy_enumerate (GSocketConnectable *connectable)
{
  GSocketConnectableIface *iface;
 ...
 */
xchar_t *
xsocket_connectable_to_string (GSocketConnectable *connectable)
{
  GSocketConnectableIface *iface;
