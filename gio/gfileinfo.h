...
#define XTYPE_FILE_INFO         (g_file_info_get_type ())
#define G_FILE_INFO(o)           (XTYPE_CHECK_INSTANCE_CAST ((o), XTYPE_FILE_INFO, GFileInfo))
#define G_FILE_INFO_CLASS(k)     (XTYPE_CHECK_CLASS_CAST((k), XTYPE_FILE_INFO, GFileInfoClass))
...
#define G_FILE_INFO_GET_CLASS(o) (XTYPE_INSTANCE_GET_CLASS ((o), XTYPE_FILE_INFO, GFileInfoClass))
 ...
 **/
#define G_FILE_ATTRIBUTE_STANDARD_ICON "standard::icon"                     /* object (xicon_t) */
 ...
 * Since: 2.34
 **/
#define G_FILE_ATTRIBUTE_STANDARD_SYMBOLIC_ICON "standard::symbolic-icon"   /* object (xicon_t) */
 ...
 * Since: 2.20
 **/
#define G_FILE_ATTRIBUTE_PREVIEW_ICON "preview::icon"         /* object (xicon_t) */
...
xtype_t              g_file_info_get_type                  (void) G_GNUC_CONST;
...
void               g_file_info_copy_into                 (GFileInfo  *src_info,
							  GFileInfo  *dest_info);
XPL_AVAILABLE_IN_ALL
xboolean_t           g_file_info_has_attribute             (GFileInfo  *info,
							  const char *attribute);
XPL_AVAILABLE_IN_ALL
xboolean_t           g_file_info_has_namespace             (GFileInfo  *info,
							  const char *name_space);
XPL_AVAILABLE_IN_ALL
char **            g_file_info_list_attributes           (GFileInfo  *info,
							  const char *name_space);
XPL_AVAILABLE_IN_ALL
xboolean_t           g_file_info_get_attribute_data        (GFileInfo  *info,
							  const char *attribute,
...
GFileAttributeStatus g_file_info_get_attribute_status    (GFileInfo  *info,
							  const char *attribute);
XPL_AVAILABLE_IN_ALL
xboolean_t           g_file_info_set_attribute_status      (GFileInfo  *info,
							  const char *attribute,
							  GFileAttributeStatus status);
XPL_AVAILABLE_IN_ALL
...
const char *       g_file_info_get_attribute_byte_string (GFileInfo  *info,
							  const char *attribute);
XPL_AVAILABLE_IN_ALL
xboolean_t           g_file_info_get_attribute_boolean     (GFileInfo  *info,
							  const char *attribute);
XPL_AVAILABLE_IN_ALL
...
gint64             g_file_info_get_attribute_int64       (GFileInfo  *info,
							  const char *attribute);
XPL_AVAILABLE_IN_ALL
xobject_t *          g_file_info_get_attribute_object      (GFileInfo  *info,
							  const char *attribute);
XPL_AVAILABLE_IN_ALL
...
XPL_AVAILABLE_IN_ALL
xboolean_t          g_file_info_get_is_hidden          (GFileInfo         *info);
XPL_AVAILABLE_IN_ALL
xboolean_t          g_file_info_get_is_backup          (GFileInfo         *info);
XPL_AVAILABLE_IN_ALL
xboolean_t          g_file_info_get_is_symlink         (GFileInfo         *info);
XPL_AVAILABLE_IN_ALL
...
XPL_AVAILABLE_IN_ALL
xicon_t *           g_file_info_get_icon               (GFileInfo         *info);
XPL_AVAILABLE_IN_ALL
xicon_t *           g_file_info_get_symbolic_icon      (GFileInfo         *info);
XPL_AVAILABLE_IN_ALL
const char *      g_file_info_get_content_type       (GFileInfo         *info);
XPL_AVAILABLE_IN_ALL
goffset           g_file_info_get_size               (GFileInfo         *info);
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
XPL_DEPRECATED_IN_2_62_FOR(g_file_info_get_modification_date_time)
...
void              g_file_info_set_size               (GFileInfo         *info,
						      goffset            size);
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
XPL_DEPRECATED_IN_2_62_FOR(g_file_info_set_modification_date_time)
...
#define XTYPE_FILE_ATTRIBUTE_MATCHER (g_file_attribute_matcher_get_type ())
XPL_AVAILABLE_IN_ALL
xtype_t g_file_attribute_matcher_get_type (void) G_GNUC_CONST;
...
XPL_AVAILABLE_IN_ALL
xboolean_t               g_file_attribute_matcher_matches        (GFileAttributeMatcher *matcher,
								const char            *attribute);
XPL_AVAILABLE_IN_ALL
xboolean_t               g_file_attribute_matcher_matches_only   (GFileAttributeMatcher *matcher,
								const char            *attribute);
XPL_AVAILABLE_IN_ALL
xboolean_t               g_file_attribute_matcher_enumerate_namespace (GFileAttributeMatcher *matcher,
								     const char            *ns);
XPL_AVAILABLE_IN_ALL
