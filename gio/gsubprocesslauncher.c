...
G_DEFINE_TYPE (GSubprocessLauncher, g_subprocess_launcher, XTYPE_OBJECT)
      ...
      if (n_bits)
        {
          ...
          class = g_type_class_peek (XTYPE_SUBPROCESS_FLAGS);
...
static void
g_subprocess_launcher_set_property (xobject_t *object, xuint_t prop_id,
...
static void
g_subprocess_launcher_dispose (xobject_t *object)
{
...
g_subprocess_launcher_new (GSubprocessFlags flags)
{
  ...
  return g_object_new (XTYPE_SUBPROCESS_LAUNCHER,
                       "flags", flags,
                       NULL);
}
                             ...
                             ...)
{
  ...
  result = g_subprocess_launcher_spawnv (launcher, (const xchar_t * const *) args->pdata, error);
                              ...
                              xerror_t              **error)
{
  ...
  subprocess = g_object_new (XTYPE_SUBPROCESS,
                             "argv", argv,
