...
G_DEFINE_TYPE_WITH_CODE (GSimpleProxyResolver, g_simple_proxy_resolver, XTYPE_OBJECT,
...
static void
g_simple_proxy_resolver_finalize (xobject_t *object)
{
...
static void
g_simple_proxy_resolver_set_property (xobject_t      *object,
                                      xuint_t         prop_id,
                                      const GValue *value,
                                      GParamSpec   *pspec)
{
...
static void
g_simple_proxy_resolver_get_property (xobject_t    *object,
                                      xuint_t       prop_id,
                                      GValue     *value,
                                      GParamSpec *pspec)
{
 ...
 */
GProxyResolver *
g_simple_proxy_resolver_new (const xchar_t  *default_proxy,
                             xchar_t       **ignore_hosts)
{
  return g_object_new (XTYPE_SIMPLE_PROXY_RESOLVER,
