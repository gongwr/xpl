...
#define G_DTLS_CONNECTION(inst)               (XTYPE_CHECK_INSTANCE_CAST ((inst), XTYPE_DTLS_CONNECTION, xdtls_connection))
...
XPL_AVAILABLE_IN_2_48
void                  g_dtls_connection_set_database                (xdtls_connection_t       *conn,
                                                                     xtls_database_t          *database);
XPL_AVAILABLE_IN_2_48
xtls_database_t         *g_dtls_connection_get_database                (xdtls_connection_t       *conn);

XPL_AVAILABLE_IN_2_48
void                  g_dtls_connection_set_certificate             (xdtls_connection_t       *conn,
                                                                     xtls_certificate_t       *certificate);
XPL_AVAILABLE_IN_2_48
xtls_certificate_t      *g_dtls_connection_get_certificate             (xdtls_connection_t       *conn);

XPL_AVAILABLE_IN_2_48
void                  g_dtls_connection_set_interaction             (xdtls_connection_t       *conn,
                                                                     xtls_interaction_t       *interaction);
XPL_AVAILABLE_IN_2_48
xtls_interaction_t      *g_dtls_connection_get_interaction             (xdtls_connection_t       *conn);

XPL_AVAILABLE_IN_2_48
xtls_certificate_t      *g_dtls_connection_get_peer_certificate        (xdtls_connection_t       *conn);
XPL_AVAILABLE_IN_2_48
GTlsCertificateFlags  g_dtls_connection_get_peer_certificate_errors (xdtls_connection_t       *conn);

XPL_AVAILABLE_IN_2_48
void                  g_dtls_connection_set_require_close_notify    (xdtls_connection_t       *conn,
                                                                     xboolean_t               require_close_notify);
XPL_AVAILABLE_IN_2_48
xboolean_t              g_dtls_connection_get_require_close_notify    (xdtls_connection_t       *conn);

G_GNUC_BEGIN_IGNORE_DEPRECATIONS
XPL_DEPRECATED_IN_2_60
void                  g_dtls_connection_set_rehandshake_mode        (xdtls_connection_t       *conn,
                                                                     GTlsRehandshakeMode    mode);
XPL_DEPRECATED_IN_2_60
GTlsRehandshakeMode   g_dtls_connection_get_rehandshake_mode        (xdtls_connection_t       *conn);
G_GNUC_END_IGNORE_DEPRECATIONS

XPL_AVAILABLE_IN_2_48
xboolean_t              g_dtls_connection_handshake                   (xdtls_connection_t       *conn,
                                                                     xcancellable_t          *cancellable,
                                                                     xerror_t               **error);

XPL_AVAILABLE_IN_2_48
void                  g_dtls_connection_handshake_async             (xdtls_connection_t       *conn,
                                                                     int                    io_priority,
                                                                     xcancellable_t          *cancellable,
                                                                     xasync_ready_callback_t    callback,
                                                                     xpointer_t               user_data);
XPL_AVAILABLE_IN_2_48
xboolean_t              g_dtls_connection_handshake_finish            (xdtls_connection_t       *conn,
                                                                     xasync_result_t          *result,
                                                                     xerror_t               **error);

XPL_AVAILABLE_IN_2_48
xboolean_t              g_dtls_connection_shutdown                    (xdtls_connection_t       *conn,
                                                                     xboolean_t               shutdown_read,
                                                                     xboolean_t               shutdown_write,
                                                                     xcancellable_t          *cancellable,
                                                                     xerror_t               **error);
...
XPL_AVAILABLE_IN_2_48
void                  g_dtls_connection_shutdown_async              (xdtls_connection_t       *conn,
                                                                     xboolean_t               shutdown_read,
                                                                     xboolean_t               shutdown_write,
                                                                     int                    io_priority,
                                                                     xcancellable_t          *cancellable,
                                                                     ...
                                                                     xpointer_t               user_data);
XPL_AVAILABLE_IN_2_48
xboolean_t              g_dtls_connection_shutdown_finish             (xdtls_connection_t       *conn,
                                                                     xasync_result_t          *result,
                                                                     xerror_t               **error);

XPL_AVAILABLE_IN_2_48
xboolean_t              g_dtls_connection_close                       (xdtls_connection_t       *conn,
                                                                     xcancellable_t          *cancellable,
                                                                     xerror_t               **error);

XPL_AVAILABLE_IN_2_48
void                  g_dtls_connection_close_async                 (xdtls_connection_t       *conn,
                                                                     int                    io_priority,
                                                                     xcancellable_t          *cancellable,
                                                                     xasync_ready_callback_t    callback,
                                                                     xpointer_t               user_data);
XPL_AVAILABLE_IN_2_48
xboolean_t              g_dtls_connection_close_finish                (xdtls_connection_t       *conn,
                                                                     xasync_result_t          *result,
                                                                     xerror_t               **error);

/*< protected >*/
XPL_AVAILABLE_IN_2_48
xboolean_t              g_dtls_connection_emit_accept_certificate     (xdtls_connection_t       *conn,
                                                                     xtls_certificate_t       *peer_cert,
                                                                     GTlsCertificateFlags   errors);
XPL_AVAILABLE_IN_2_60
void                  g_dtls_connection_set_advertised_protocols    (xdtls_connection_t     *conn,
                                                                     const xchar_t * const *protocols);

XPL_AVAILABLE_IN_2_60
const xchar_t *          g_dtls_connection_get_negotiated_protocol     (xdtls_connection_t    *conn);

G_GNUC_BEGIN_IGNORE_DEPRECATIONS
XPL_AVAILABLE_IN_2_66
xboolean_t              g_dtls_connection_get_channel_binding_data    (xdtls_connection_t         *conn,
                                                                     GTlsChannelBindingType   type,
                                                                     xbyte_array_t              *data,
                                                                     xerror_t                 **error);
G_GNUC_END_IGNORE_DEPRECATIONS
...
GTlsProtocolVersion   g_dtls_connection_get_protocol_version        (xdtls_connection_t       *conn);

XPL_AVAILABLE_IN_2_70
xchar_t *               g_dtls_connection_get_ciphersuite_name        (xdtls_connection_t       *conn);
