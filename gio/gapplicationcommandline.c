 ...
 *
 * The #xinput_stream_t can be used to read data passed to the standard
 ...
 *
 * Returns: (nullable) (transfer full): a #xinput_stream_t for stdin
 *
 * Since: 2.34
 **/
xinput_stream_t *
 ...
 *
 * This is a #xvariant_t dictionary containing information about the
