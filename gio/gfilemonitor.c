...
G_DEFINE_ABSTRACT_TYPE_WITH_PRIVATE (GFileMonitor, g_file_monitor, XTYPE_OBJECT)
...
static xuint_t g_file_monitor_changed_signal;

static void
g_file_monitor_set_property (xobject_t      *object,
                             xuint_t         prop_id,
                             const GValue *value,
                             GParamSpec   *pspec)
{
...
static void
g_file_monitor_get_property (xobject_t    *object,
                             xuint_t       prop_id,
                             GValue     *value,
                             GParamSpec *pspec)
{
...
static void
g_file_monitor_dispose (xobject_t *object)
{
...
g_file_monitor_class_init (GFileMonitorClass *klass)
{
   ...
   * %G_FILE_MONITOR_EVENT_MOVED, @file will be set to a #xfile_t containing the
