...
static void xsocket_input_stream_pollable_iface_init (xpollable_input_stream_interface_t *iface);
#ifdef G_OS_UNIX
...
static void
xsocket_input_stream_pollable_iface_init (xpollable_input_stream_interface_t *iface)
{
