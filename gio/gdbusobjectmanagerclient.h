...
#define G_DBUS_OBJECT_MANAGER_CLIENT(o)           (XTYPE_CHECK_INSTANCE_CAST ((o), XTYPE_DBUS_OBJECT_MANAGER_CLIENT, GDBusObjectManagerClient))
...
XPL_AVAILABLE_IN_ALL
GDBusObjectManager           *g_dbus_object_manager_client_new_finish         (xasync_result_t                  *res,
                                                                               xerror_t                       **error);
XPL_AVAILABLE_IN_ALL
...
void                          g_dbus_object_manager_client_new_for_bus        (GBusType                       bus_type,
                                                                               ...
                                                                               xpointer_t                       user_data);
XPL_AVAILABLE_IN_ALL
GDBusObjectManager           *g_dbus_object_manager_client_new_for_bus_finish (xasync_result_t                  *res,
                                                                               xerror_t                       **error);
XPL_AVAILABLE_IN_ALL
...
XPL_AVAILABLE_IN_ALL
const xchar_t                  *g_dbus_object_manager_client_get_name           (GDBusObjectManagerClient      *manager);
XPL_AVAILABLE_IN_ALL
xchar_t                        *g_dbus_object_manager_client_get_name_owner     (GDBusObjectManagerClient      *manager);
