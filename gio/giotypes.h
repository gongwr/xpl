 ...
 **/
typedef xboolean_t (* GFileReadMoreCallback) (const char *file_contents,
                                            goffset file_size,
 ...
 * Since: 2.38
 **/
typedef void (* GFileMeasureProgressCallback) (xboolean_t reporting,
 ...
 **/
typedef xboolean_t (*GIOSchedulerJobFunc) (GIOSchedulerJob *job,
 ...
 * Since: 2.22
 */
typedef xboolean_t (*GSocketSourceFunc) (xsocket_t *socket,
 ...
 * Since: 2.48
 */
typedef xboolean_t (*GDatagramBasedSourceFunc) (GDatagramBased *datagram_based,
                                              GIOCondition    condition,
                                              xpointer_t        user_data);
 ...
 * Since: 2.28
 */
typedef xboolean_t (*GCancellableSourceFunc) (xcancellable_t *cancellable,
					    xpointer_t      user_data);
 ...
 * Since: 2.28
 */
typedef xboolean_t (*GPollableSourceFunc) (xobject_t  *pollable_stream,
					 xpointer_t  user_data);
 ...
 * @interface_name: (nullable): The interface name of the remote object or %NULL if a #GDBusObjectProxy #xtype_t is requested.
 * @user_data: User data.
 *
 ...
 * Since: 2.30
 */
typedef xtype_t (*GDBusProxyTypeFunc) (GDBusObjectManagerClient   *manager,
