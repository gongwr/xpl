 ...
 * on their base #GDatagramBased if it is a #xsocket_t — it is up to the caller to
...
G_DEFINE_INTERFACE (GDtlsConnection, g_dtls_connection, XTYPE_DATAGRAM_BASED)
...
g_dtls_connection_default_init (GDtlsConnectionInterface *iface)
{
   ...
   * implementation of #GDatagramBased, not just a #xsocket_t.
   *
   * Since: 2.48
   */
