 ...
 * @include: gio/gio.h
 * @see_also: #xasync_result_t, #GTask
 *
 * As of GLib 2.46, #GSimpleAsyncResult is deprecated in favor of
 * #GTask, which provides a simpler API.
 *
 * #GSimpleAsyncResult implements #xasync_result_t.
 *
 ...
 * g_simple_async_result_new_take_error(). If a #xerror_t is not available
...
G_DEFINE_TYPE_WITH_CODE (GSimpleAsyncResult, g_simple_async_result, XTYPE_OBJECT,
...
static void
g_simple_async_result_finalize (xobject_t *object)
{
  GSimpleAsyncResult *simple;
 ...
 **/
GSimpleAsyncResult *
g_simple_async_result_new (xobject_t             *source_object,
                           xasync_ready_callback_t  callback,
                           xpointer_t             user_data,
                           xpointer_t             source_tag)
{
  ...
  simple = g_object_new (XTYPE_SIMPLE_ASYNC_RESULT, NULL);
 ...
 **/
GSimpleAsyncResult *
g_simple_async_result_new_from_error (xobject_t             *source_object,
                                      xasync_ready_callback_t  callback,
                                      xpointer_t             user_data,
 ...
 **/
GSimpleAsyncResult *
g_simple_async_result_new_take_error (xobject_t             *source_object,
                                      xasync_ready_callback_t  callback,
                                      xpointer_t             user_data,
                                      xerror_t              *error)
{
 ...
 **/
GSimpleAsyncResult *
g_simple_async_result_new_error (xobject_t             *source_object,
                                 xasync_ready_callback_t  callback,
                                 xpointer_t             user_data,
                                 GQuark               domain,
                                 xint_t                 code,
...
static xpointer_t
g_simple_async_result_get_user_data (xasync_result_t *res)
{
  return G_SIMPLE_ASYNC_RESULT (res)->user_data;
}

static xobject_t *
g_simple_async_result_get_source_object (xasync_result_t *res)
{
...
static xboolean_t
g_simple_async_result_is_tagged (xasync_result_t *res,
				 xpointer_t      source_tag)
{
 ...
 * #xcancellable_t passed to g_simple_async_result_run_in_thread().
 *
 * Deprecated: 2.46
 **/
void
 ...
 *
 * Returns: a #xpointer_t to the source object for the #GSimpleAsyncResult.
 *
 ...
 **/
xboolean_t
g_simple_async_result_is_valid (xasync_result_t *result,
                                xobject_t      *source,
                                xpointer_t      source_tag)
{
  GSimpleAsyncResult *simple;
