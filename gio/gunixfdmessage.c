...
{
  GSocketControlMessageClass *scm_class = XSOCKET_CONTROL_MESSAGE_CLASS (class);
...
{
  return g_object_new (XTYPE_UNIX_FD_MESSAGE, NULL);
}
...
{
  return g_object_new (XTYPE_UNIX_FD_MESSAGE,
                       "fd-list", fd_list,
                       NULL);
}
