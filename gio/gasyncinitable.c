 ...
 *                                xpointer_t data)
 * {
 *   GAsyncInitableIface *iface = x_iface;
 *
...
static void     g_async_initable_real_init_async  (GAsyncInitable       *initable,
						   ...
						   xasync_ready_callback_t   callback,
						   xpointer_t              user_data);
static xboolean_t g_async_initable_real_init_finish (GAsyncInitable       *initable,
						   xasync_result_t         *res,
						   xerror_t              **error);


typedef GAsyncInitableIface GAsyncInitableInterface;
G_DEFINE_INTERFACE (GAsyncInitable, g_async_initable, XTYPE_OBJECT)
 ...
 * @object_type: a #xtype_t supporting #GAsyncInitable.
 * @io_priority: the [I/O priority][io-priority] of the operation
 * @cancellable: optional #xcancellable_t object, %NULL to ignore.
 ...
 */
void
g_async_initable_new_async (xtype_t                object_type,
			    int                  io_priority,
			    xcancellable_t        *cancellable,
			    xasync_ready_callback_t  callback,
			    xpointer_t             user_data,
...
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
void
g_async_initable_newv_async (xtype_t                object_type,
 ...
 */
void
g_async_initable_new_valist_async (xtype_t                object_type,
				   const xchar_t         *first_property_name,
				   va_list              var_args,
				   int                  io_priority,
				   xcancellable_t        *cancellable,
