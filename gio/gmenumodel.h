...
#define XTYPE_MENU_MODEL                                   (g_menu_model_get_type ())
#define G_MENU_MODEL(inst)                                  (XTYPE_CHECK_INSTANCE_CAST ((inst),                     \
                                                             XTYPE_MENU_MODEL, GMenuModel))
#define G_MENU_MODEL_CLASS(class)                           (XTYPE_CHECK_CLASS_CAST ((class),                       \
                                                             XTYPE_MENU_MODEL, GMenuModelClass))
...
#define X_IS_MENU_MODEL_CLASS(class)                        (XTYPE_CHECK_CLASS_TYPE ((class),                       \
                                                             XTYPE_MENU_MODEL))
#define G_MENU_MODEL_GET_CLASS(inst)                        (XTYPE_INSTANCE_GET_CLASS ((inst),                      \
                                                             XTYPE_MENU_MODEL, GMenuModelClass))
...
struct _GMenuModelClass
{
  ...
  xboolean_t              (*is_mutable)                       (GMenuModel          *model);
  xint_t                  (*get_n_items)                      (GMenuModel          *model);
  void                  (*get_item_attributes)              (GMenuModel          *model,
                                                             xint_t                 item_index,
                                                             GHashTable         **attributes);
  GMenuAttributeIter *  (*iterate_item_attributes)          (GMenuModel          *model,
                                                             xint_t                 item_index);
  xvariant_t *            (*get_item_attribute_value)         (GMenuModel          *model,
                                                             xint_t                 item_index,
...
xtype_t                   g_menu_model_get_type                           (void) G_GNUC_CONST;

XPL_AVAILABLE_IN_2_32
xboolean_t                g_menu_model_is_mutable                         (GMenuModel         *model);
XPL_AVAILABLE_IN_2_32
xint_t                    g_menu_model_get_n_items                        (GMenuModel         *model);

XPL_AVAILABLE_IN_2_32
GMenuAttributeIter *    g_menu_model_iterate_item_attributes            (GMenuModel         *model,
                                                                         xint_t                item_index);
XPL_AVAILABLE_IN_2_32
xvariant_t *              g_menu_model_get_item_attribute_value           (GMenuModel         *model,
                                                                         xint_t                item_index,
                                                                         const xchar_t        *attribute,
                                                                         const xvariant_type_t *expected_type);
XPL_AVAILABLE_IN_2_32
xboolean_t                g_menu_model_get_item_attribute                 (GMenuModel         *model,
                                                                         xint_t                item_index,
                                                                         const xchar_t        *attribute,
...
#define XTYPE_MENU_ATTRIBUTE_ITER                          (g_menu_attribute_iter_get_type ())
#define G_MENU_ATTRIBUTE_ITER(inst)                         (XTYPE_CHECK_INSTANCE_CAST ((inst),                     \
                                                             XTYPE_MENU_ATTRIBUTE_ITER, GMenuAttributeIter))
#define G_MENU_ATTRIBUTE_ITER_CLASS(class)                  (XTYPE_CHECK_CLASS_CAST ((class),                       \
                                                             XTYPE_MENU_ATTRIBUTE_ITER, GMenuAttributeIterClass))
...
#define X_IS_MENU_ATTRIBUTE_ITER_CLASS(class)               (XTYPE_CHECK_CLASS_TYPE ((class),                       \
                                                             XTYPE_MENU_ATTRIBUTE_ITER))
#define G_MENU_ATTRIBUTE_ITER_GET_CLASS(inst)               (XTYPE_INSTANCE_GET_CLASS ((inst),                      \
                                                             XTYPE_MENU_ATTRIBUTE_ITER, GMenuAttributeIterClass))
...
struct _GMenuAttributeIterClass
{
  ...
  xboolean_t      (*get_next) (GMenuAttributeIter  *iter,
                             const xchar_t        **out_name,
                             xvariant_t           **value);
};

XPL_AVAILABLE_IN_2_32
xtype_t                   g_menu_attribute_iter_get_type                  (void) G_GNUC_CONST;

XPL_AVAILABLE_IN_2_32
xboolean_t                g_menu_attribute_iter_get_next                  (GMenuAttributeIter  *iter,
                                                                         const xchar_t        **out_name,
                                                                         xvariant_t           **value);
XPL_AVAILABLE_IN_2_32
xboolean_t                g_menu_attribute_iter_next                      (GMenuAttributeIter  *iter);
XPL_AVAILABLE_IN_2_32
const xchar_t *           g_menu_attribute_iter_get_name                  (GMenuAttributeIter  *iter);
XPL_AVAILABLE_IN_2_32
xvariant_t *              g_menu_attribute_iter_get_value                 (GMenuAttributeIter  *iter);


#define XTYPE_MENU_LINK_ITER                               (g_menu_link_iter_get_type ())
#define G_MENU_LINK_ITER(inst)                              (XTYPE_CHECK_INSTANCE_CAST ((inst),                     \
                                                             XTYPE_MENU_LINK_ITER, GMenuLinkIter))
#define G_MENU_LINK_ITER_CLASS(class)                       (XTYPE_CHECK_CLASS_CAST ((class),                       \
                                                             XTYPE_MENU_LINK_ITER, GMenuLinkIterClass))
...
#define X_IS_MENU_LINK_ITER_CLASS(class)                    (XTYPE_CHECK_CLASS_TYPE ((class),                       \
                                                             XTYPE_MENU_LINK_ITER))
#define G_MENU_LINK_ITER_GET_CLASS(inst)                    (XTYPE_INSTANCE_GET_CLASS ((inst),                      \
                                                             XTYPE_MENU_LINK_ITER, GMenuLinkIterClass))
...
struct _GMenuLinkIterClass
{
  ...
  xboolean_t      (*get_next) (GMenuLinkIter  *iter,
                             const xchar_t   **out_link,
                             GMenuModel    **value);
};

XPL_AVAILABLE_IN_2_32
xtype_t                   g_menu_link_iter_get_type                       (void) G_GNUC_CONST;

XPL_AVAILABLE_IN_2_32
xboolean_t                g_menu_link_iter_get_next                       (GMenuLinkIter  *iter,
                                                                         const xchar_t   **out_link,
                                                                         GMenuModel    **value);
XPL_AVAILABLE_IN_2_32
xboolean_t                g_menu_link_iter_next                           (GMenuLinkIter  *iter);
XPL_AVAILABLE_IN_2_32
const xchar_t *           g_menu_link_iter_get_name                       (GMenuLinkIter  *iter);
XPL_AVAILABLE_IN_2_32
