                     ...
                     xpointer_t     user_data)
{
  ...
  *res = (xinput_stream_t *) g_file_read (file, NULL, &error);
                          ...
                          xerror_t **error)
{
  ...
  if (((guintptr) g_bytes_get_data (data, NULL)) % sizeof (xpointer_t) != 0)
    {
                                ...
                                xerror_t               **error)
{
  ...
  if (hash == NULL)
    ...
    {
      children = (xchar_t **) g_hash_table_get_keys_as_array (hash, NULL);
