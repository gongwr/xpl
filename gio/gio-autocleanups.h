...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xasync_result_t, g_object_unref)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xcancellable_t, g_object_unref)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xdrive_t, g_object_unref)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xfile_t, g_object_unref)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xicon_t, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xinet_address_t, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xinet_address_mask_t, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(GInetSocketAddress, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(GInitable, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xinput_stream_t, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(GIOModule, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xio_stream_t, g_object_unref)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xmount_operation_t, g_object_unref)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xoutput_stream_t, g_object_unref)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xresource_t, g_resource_unref)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xsocket_address_t, g_object_unref)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xsocket_connection_t, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(GSocketControlMessage, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(xsocket_t, g_object_unref)
