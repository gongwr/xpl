 ...
 *
 * The GActionMap interface is implemented by #xaction_group_t
...
G_DEFINE_INTERFACE (GActionMap, g_action_map, XTYPE_OBJECT)
      ...
      if (entry->state)
        {
          ...
          if (state == NULL)
            {
              g_critical ("g_action_map_add_entries: xvariant_t could "
