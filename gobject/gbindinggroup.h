...
#define G_BINDING_GROUP(obj)    (XTYPE_CHECK_INSTANCE_CAST ((obj), XTYPE_BINDING_GROUP, GBindingGroup))
#define X_IS_BINDING_GROUP(obj) (XTYPE_CHECK_INSTANCE_TYPE ((obj), XTYPE_BINDING_GROUP))
#define XTYPE_BINDING_GROUP    (g_binding_group_get_type())
...
xtype_t          g_binding_group_get_type           (void) G_GNUC_CONST;
XPL_AVAILABLE_IN_2_72
GBindingGroup *g_binding_group_new                (void);
XPL_AVAILABLE_IN_2_72
xpointer_t       g_binding_group_dup_source         (GBindingGroup         *self);
XPL_AVAILABLE_IN_2_72
