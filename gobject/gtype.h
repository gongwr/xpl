 ...
 */
#define XTYPE_FUNDAMENTAL(type)	(g_type_fundamental (type))
/**
 ...
 * Returns: %TRUE on success
 */
#define XTYPE_IS_CLASSED(type)                 (g_type_test_flags ((type), XTYPE_FLAG_CLASSED))
/**
 ...
 * Returns: %TRUE on success
 */
#define XTYPE_IS_INSTANTIATABLE(type)          (g_type_test_flags ((type), XTYPE_FLAG_INSTANTIATABLE))
/**
 * XTYPE_IS_DERIVABLE:
 * @type: A #xtype_t value
 *
 ...
 * Returns: %TRUE on success
 */
#define XTYPE_IS_DERIVABLE(type)               (g_type_test_flags ((type), XTYPE_FLAG_DERIVABLE))
/**
 ...
 * Returns: %TRUE on success
 */
#define XTYPE_IS_DEEP_DERIVABLE(type)          (g_type_test_flags ((type), XTYPE_FLAG_DEEP_DERIVABLE))
/**
 * XTYPE_IS_ABSTRACT:
 * @type: A #xtype_t value
 *
 ...
 * Returns: %TRUE on success
 */
#define XTYPE_IS_ABSTRACT(type)                (g_type_test_flags ((type), XTYPE_FLAG_ABSTRACT))
/**
 ...
 * Returns: %TRUE on success
 */
#define XTYPE_IS_VALUE_ABSTRACT(type)          (g_type_test_flags ((type), XTYPE_FLAG_VALUE_ABSTRACT))
/**
 * XTYPE_IS_VALUE_TYPE:
 * @type: A #xtype_t value
 *
 ...
 * Returns: %TRUE on success
 */
#define XTYPE_IS_VALUE_TYPE(type)              (g_type_check_is_value_type (type))
/**
 ...
 * Returns: %TRUE on success
 */
#define XTYPE_HAS_VALUE_TABLE(type)            (g_type_value_table_peek (type) != NULL)
/**
 * XTYPE_IS_FINAL:
 * @type: a #xtype_t value
 *
 ...
 * Since: 2.70
 */
#define XTYPE_IS_FINAL(type)                   (g_type_test_flags ((type), XTYPE_FLAG_FINAL)) XPL_AVAILABLE_MACRO_IN_2_70
 ...
 * This macro should only be used in type implementations.
 */
#define XTYPE_CHECK_INSTANCE_CAST(instance, g_type, c_type)    (_XTYPE_CIC ((instance), (g_type), c_type))
/**
 ...
 * Returns: the #xtype_t
 */
#define XTYPE_FROM_CLASS(g_class)                              (((GTypeClass*) (g_class))->g_type)
/**
 ...
 */
#define XTYPE_INSTANCE_GET_PRIVATE(instance, g_type, c_type)   ((c_type*) g_type_instance_get_private ((GTypeInstance*) (instance), (g_type))) XPL_DEPRECATED_MACRO_IN_2_58_FOR(G_ADD_PRIVATE)
 ...
 * Returns: (not nullable): a pointer to the private data structure
 */
#define XTYPE_CLASS_GET_PRIVATE(klass, g_type, c_type)   ((c_type*) g_type_class_get_private ((GTypeClass*) (klass), (g_type)))
...
const xchar_t *         g_type_name                    (xtype_t            type);
XPL_AVAILABLE_IN_ALL
GQuark                g_type_qname                   (xtype_t            type);
XPL_AVAILABLE_IN_ALL
xtype_t                 g_type_from_name               (const xchar_t     *name);
XPL_AVAILABLE_IN_ALL
xtype_t                 g_type_parent                  (xtype_t            type);
XPL_AVAILABLE_IN_ALL
xuint_t                 g_type_depth                   (xtype_t            type);
XPL_AVAILABLE_IN_ALL
xtype_t                 g_type_next_base               (xtype_t            leaf_type,
						      xtype_t            root_type);
XPL_AVAILABLE_IN_ALL
xboolean_t              g_type_is_a                    (xtype_t            type,
						      xtype_t            is_a_type);
XPL_AVAILABLE_IN_ALL
xpointer_t              g_type_class_ref               (xtype_t            type);
XPL_AVAILABLE_IN_ALL
xpointer_t              g_type_class_peek              (xtype_t            type);
XPL_AVAILABLE_IN_ALL
xpointer_t              g_type_class_peek_static       (xtype_t            type);
XPL_AVAILABLE_IN_ALL
void                  g_type_class_unref             (xpointer_t         g_class);
XPL_AVAILABLE_IN_ALL
xpointer_t              g_type_class_peek_parent       (xpointer_t         g_class);
XPL_AVAILABLE_IN_ALL
xpointer_t              g_type_interface_peek          (xpointer_t         instance_class,
						      xtype_t            iface_type);
XPL_AVAILABLE_IN_ALL
xpointer_t              g_type_interface_peek_parent   (xpointer_t         x_iface);

XPL_AVAILABLE_IN_ALL
xpointer_t              g_type_default_interface_ref   (xtype_t            g_type);
XPL_AVAILABLE_IN_ALL
xpointer_t              g_type_default_interface_peek  (xtype_t            g_type);
XPL_AVAILABLE_IN_ALL
void                  g_type_default_interface_unref (xpointer_t         x_iface);

/* g_free() the returned arrays */
XPL_AVAILABLE_IN_ALL
xtype_t*                g_type_children                (xtype_t            type,
						      xuint_t           *n_children);
XPL_AVAILABLE_IN_ALL
xtype_t*                g_type_interfaces              (xtype_t            type,
						      xuint_t           *n_interfaces);

/* per-type _static_ data */
XPL_AVAILABLE_IN_ALL
void                  g_type_set_qdata               (xtype_t            type,
						      GQuark           quark,
						      xpointer_t         data);
XPL_AVAILABLE_IN_ALL
xpointer_t              g_type_get_qdata               (xtype_t            type,
						      GQuark           quark);
XPL_AVAILABLE_IN_ALL
void		      g_type_query		     (xtype_t	       type,
						      GTypeQuery      *query);

XPL_AVAILABLE_IN_2_44
int                   g_type_get_instance_count      (xtype_t            type);

/* --- type registration --- */
/**
 * GBaseInitFunc:
 * @g_class: (type xobject_t.TypeClass): The #GTypeClass structure to initialize
 *
 ...
 */
typedef void   (*GBaseInitFunc)              (xpointer_t         g_class);
/**
 * GBaseFinalizeFunc:
 * @g_class: (type xobject_t.TypeClass): The #GTypeClass structure to finalize
 *
 ...
 */
typedef void   (*GBaseFinalizeFunc)          (xpointer_t         g_class);
/**
 * GClassInitFunc:
 * @g_class: (type xobject_t.TypeClass): The #GTypeClass structure to initialize.
 ...
 * time.
 */
typedef void   (*GClassInitFunc)             (xpointer_t         g_class,
 ...
 */
typedef void   (*GClassFinalizeFunc)         (xpointer_t         g_class,
					      xpointer_t         class_data);
/**
 * GInstanceInitFunc:
 ...
 * @g_class: (type xobject_t.TypeClass): The #GTypeClass structure which is
 *    unreferenced
 *
...
struct _GTypeValueTable
{
  ...
  xpointer_t (*value_peek_pointer) (const GValue *value);
  const xchar_t *collect_format;
  xchar_t*   (*collect_value)      (GValue       *value,
				  xuint_t         n_collect_values,
				  GTypeCValue  *collect_values,
				  xuint_t		collect_flags);
  const xchar_t *lcopy_format;
  xchar_t*   (*lcopy_value)        (const GValue *value,
				  xuint_t         n_collect_values,
				  GTypeCValue  *collect_values,
				  xuint_t		collect_flags);
};
XPL_AVAILABLE_IN_ALL
xtype_t g_type_register_static		(xtype_t			     parent_type,
					 const xchar_t		    *type_name,
					 const GTypeInfo	    *info,
					 GTypeFlags		     flags);
XPL_AVAILABLE_IN_ALL
xtype_t g_type_register_static_simple     (xtype_t                       parent_type,
					 const xchar_t                *type_name,
					 xuint_t                       class_size,
					 GClassInitFunc              class_init,
					 xuint_t                       instance_size,
...
XPL_AVAILABLE_IN_ALL
xtype_t g_type_register_dynamic		(xtype_t			     parent_type,
					 const xchar_t		    *type_name,
					 GTypePlugin		    *plugin,
					 GTypeFlags		     flags);
XPL_AVAILABLE_IN_ALL
xtype_t g_type_register_fundamental	(xtype_t			     type_id,
					 const xchar_t		    *type_name,
					 const GTypeInfo	    *info,
					 const GTypeFundamentalInfo *finfo,
					 GTypeFlags		     flags);
XPL_AVAILABLE_IN_ALL
void  g_type_add_interface_static	(xtype_t			     instance_type,
					 xtype_t			     interface_type,
					 const GInterfaceInfo	    *info);
XPL_AVAILABLE_IN_ALL
void  g_type_add_interface_dynamic	(xtype_t			     instance_type,
					 xtype_t			     interface_type,
					 GTypePlugin		    *plugin);
XPL_AVAILABLE_IN_ALL
void  g_type_interface_add_prerequisite (xtype_t			     interface_type,
					 xtype_t			     prerequisite_type);
XPL_AVAILABLE_IN_ALL
xtype_t*g_type_interface_prerequisites    (xtype_t                       interface_type,
					 xuint_t                      *n_prerequisites);
XPL_AVAILABLE_IN_2_68
xtype_t g_type_interface_instantiatable_prerequisite
                                        (xtype_t                       interface_type);
XPL_DEPRECATED_IN_2_58
void     g_type_class_add_private       (xpointer_t                    g_class,
                                         xsize_t                       private_size);
XPL_AVAILABLE_IN_2_38
xint_t     g_type_add_instance_private    (xtype_t                       class_type,
                                         xsize_t                       private_size);
XPL_AVAILABLE_IN_ALL
xpointer_t g_type_instance_get_private    (GTypeInstance              *instance,
                                         xtype_t                       private_type);
XPL_AVAILABLE_IN_2_38
void     g_type_class_adjust_private_offset (xpointer_t                g_class,
                                             xint_t                   *private_size_or_offset);

XPL_AVAILABLE_IN_ALL
void      g_type_add_class_private      (xtype_t    		     class_type,
					 xsize_t    		     private_size);
XPL_AVAILABLE_IN_ALL
xpointer_t  g_type_class_get_private      (GTypeClass 		    *klass,
					 xtype_t			     private_type);
XPL_AVAILABLE_IN_2_38
xint_t      g_type_class_get_instance_private_offset (xpointer_t         g_class);

XPL_AVAILABLE_IN_2_34
void      g_type_ensure                 (xtype_t                       type);
XPL_AVAILABLE_IN_2_36
xuint_t     g_type_get_type_registration_serial (void);
...
#define G_DECLARE_FINAL_TYPE(ModuleObjName, module_obj_name, MODULE, OBJ_NAME, ParentName) \
  ...
  typedef struct { ParentName##Class parent_class; } ModuleObjName##Class;                               \
                                                                                                         \
  _XPL_DEFINE_AUTOPTR_CHAINUP (ModuleObjName, ParentName)                                               \
  G_DEFINE_AUTOPTR_CLEANUP_FUNC (ModuleObjName##Class, g_type_class_unref)                               \
                                                                                                         \
  G_GNUC_UNUSED static inline ModuleObjName * MODULE##_##OBJ_NAME (xpointer_t ptr) {                       \
    return XTYPE_CHECK_INSTANCE_CAST (ptr, module_obj_name##_get_type (), ModuleObjName); }             \
...
#define G_DECLARE_DERIVABLE_TYPE(ModuleObjName, module_obj_name, MODULE, OBJ_NAME, ParentName) \
  ...
  G_GNUC_UNUSED static inline ModuleObjName * MODULE##_##OBJ_NAME (xpointer_t ptr) {                       \
    return XTYPE_CHECK_INSTANCE_CAST (ptr, module_obj_name##_get_type (), ModuleObjName); }             \
  G_GNUC_UNUSED static inline ModuleObjName##Class * MODULE##_##OBJ_NAME##_CLASS (xpointer_t ptr) {        \
    return XTYPE_CHECK_CLASS_CAST (ptr, module_obj_name##_get_type (), ModuleObjName##Class); }         \
  G_GNUC_UNUSED static inline xboolean_t MODULE##_IS_##OBJ_NAME (xpointer_t ptr) {                           \
    return XTYPE_CHECK_INSTANCE_TYPE (ptr, module_obj_name##_get_type ()); }                            \
  ...
  G_GNUC_UNUSED static inline ModuleObjName##Class * MODULE##_##OBJ_NAME##_GET_CLASS (xpointer_t ptr) {    \
    return XTYPE_INSTANCE_GET_CLASS (ptr, module_obj_name##_get_type (), ModuleObjName##Class); }       \
  G_GNUC_END_IGNORE_DEPRECATIONS
...
#define G_DECLARE_INTERFACE(ModuleObjName, module_obj_name, MODULE, OBJ_NAME, PrerequisiteName) \
  ...
  typedef struct _##ModuleObjName##Interface ModuleObjName##Interface;                                     \
                                                                                                           \
  _XPL_DEFINE_AUTOPTR_CHAINUP (ModuleObjName, PrerequisiteName)                                           \
                                                                                                           \
  G_GNUC_UNUSED static inline ModuleObjName * MODULE##_##OBJ_NAME (xpointer_t ptr) {                         \
    return XTYPE_CHECK_INSTANCE_CAST (ptr, module_obj_name##_get_type (), ModuleObjName); }               \
  G_GNUC_UNUSED static inline xboolean_t MODULE##_IS_##OBJ_NAME (xpointer_t ptr) {                             \
    return XTYPE_CHECK_INSTANCE_TYPE (ptr, module_obj_name##_get_type ()); }                              \
  G_GNUC_UNUSED static inline ModuleObjName##Interface * MODULE##_##OBJ_NAME##_GET_IFACE (xpointer_t ptr) {  \
    return XTYPE_INSTANCE_GET_INTERFACE (ptr, module_obj_name##_get_type (), ModuleObjName##Interface); } \
  G_GNUC_END_IGNORE_DEPRECATIONS
 ...
 * Since: 2.4
 */
#define G_DEFINE_ABSTRACT_TYPE_WITH_CODE(TN, t_n, T_P, _C_) _G_DEFINE_TYPE_EXTENDED_BEGIN (TN, t_n, T_P, XTYPE_FLAG_ABSTRACT) {_C_;} _G_DEFINE_TYPE_EXTENDED_END()
/**
 ...
 * this is #guint64 or #xdouble_t). If you need larger alignment for an element in
...
{ \
  ...
  if (g_once_init_enter (&static_g_define_type_id)) \
    { \
      xtype_t g_define_type_id = \
        g_type_register_static_simple (XTYPE_INTERFACE, \
                                       g_intern_static_string (#TypeName), \
...
XPL_AVAILABLE_IN_ALL
GTypePlugin*	 g_type_get_plugin		(xtype_t		     type);
XPL_AVAILABLE_IN_ALL
GTypePlugin*	 g_type_interface_get_plugin	(xtype_t		     instance_type,
						 xtype_t               interface_type);
XPL_AVAILABLE_IN_ALL
xtype_t		 g_type_fundamental_next	(void);
XPL_AVAILABLE_IN_ALL
xtype_t		 g_type_fundamental		(xtype_t		     type_id);
XPL_AVAILABLE_IN_ALL
GTypeInstance*   g_type_create_instance         (xtype_t               type);
XPL_AVAILABLE_IN_ALL
void             g_type_free_instance           (GTypeInstance      *instance);

XPL_AVAILABLE_IN_ALL
void		 g_type_add_class_cache_func    (xpointer_t	     cache_data,
						 GTypeClassCacheFunc cache_func);
XPL_AVAILABLE_IN_ALL
void		 g_type_remove_class_cache_func (xpointer_t	     cache_data,
						 GTypeClassCacheFunc cache_func);
XPL_AVAILABLE_IN_ALL
void             g_type_class_unref_uncached    (xpointer_t            g_class);

XPL_AVAILABLE_IN_ALL
void             g_type_add_interface_check     (xpointer_t	         check_data,
						 GTypeInterfaceCheckFunc check_func);
XPL_AVAILABLE_IN_ALL
void             g_type_remove_interface_check  (xpointer_t	         check_data,
						 GTypeInterfaceCheckFunc check_func);

XPL_AVAILABLE_IN_ALL
GTypeValueTable* g_type_value_table_peek        (xtype_t		     type);


/*< private >*/
XPL_AVAILABLE_IN_ALL
xboolean_t	 g_type_check_instance          (GTypeInstance      *instance) G_GNUC_PURE;
XPL_AVAILABLE_IN_ALL
GTypeInstance*   g_type_check_instance_cast     (GTypeInstance      *instance,
						 xtype_t               iface_type);
XPL_AVAILABLE_IN_ALL
xboolean_t         g_type_check_instance_is_a	(GTypeInstance      *instance,
						 xtype_t               iface_type) G_GNUC_PURE;
XPL_AVAILABLE_IN_2_42
xboolean_t         g_type_check_instance_is_fundamentally_a (GTypeInstance *instance,
                                                           xtype_t          fundamental_type) G_GNUC_PURE;
XPL_AVAILABLE_IN_ALL
GTypeClass*      g_type_check_class_cast        (GTypeClass         *g_class,
						 xtype_t               is_a_type);
XPL_AVAILABLE_IN_ALL
xboolean_t         g_type_check_class_is_a        (GTypeClass         *g_class,
						 xtype_t               is_a_type) G_GNUC_PURE;
XPL_AVAILABLE_IN_ALL
xboolean_t	 g_type_check_is_value_type     (xtype_t		     type) G_GNUC_CONST;
XPL_AVAILABLE_IN_ALL
xboolean_t	 g_type_check_value             (const GValue       *value) G_GNUC_PURE;
XPL_AVAILABLE_IN_ALL
xboolean_t	 g_type_check_value_holds	(const GValue	    *value,
						 xtype_t		     type) G_GNUC_PURE;
XPL_AVAILABLE_IN_ALL
xboolean_t         g_type_test_flags              (xtype_t               type,
						 xuint_t               flags) G_GNUC_CONST;


/* --- debugging functions --- */
XPL_AVAILABLE_IN_ALL
const xchar_t *    g_type_name_from_instance      (GTypeInstance	*instance);
XPL_AVAILABLE_IN_ALL
const xchar_t *    g_type_name_from_class         (GTypeClass	*g_class);
...
#define _XTYPE_CHI(ip)			(g_type_check_instance ((GTypeInstance*) ip))
#define _XTYPE_CHV(vl)			(g_type_check_value ((GValue*) vl))
#define _XTYPE_IGC(ip, gt, ct)         ((ct*) (((GTypeInstance*) ip)->g_class))
#define _XTYPE_IGI(ip, gt, ct)         ((ct*) g_type_interface_peek (((GTypeInstance*) ip)->g_class, gt))
#define _XTYPE_CIFT(ip, ft)            (g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ip, ft))
#ifdef	__GNUC__
...
#  define _XTYPE_CCT(cp, gt)             (G_GNUC_EXTENSION ({ \
  GTypeClass *__class = (GTypeClass*) cp; xtype_t __t = gt; xboolean_t __r; \
  if (!__class) \
    __r = FALSE; \
...
#  define _XTYPE_CVH(vl, gt)             (G_GNUC_EXTENSION ({ \
  const GValue *__val = (const GValue*) vl; xtype_t __t = gt; xboolean_t __r; \
  if (!__val) \
    __r = FALSE; \
...
#else  /* !__GNUC__ */
#  define _XTYPE_CIT(ip, gt)             (g_type_check_instance_is_a ((GTypeInstance*) ip, gt))
#  define _XTYPE_CCT(cp, gt)             (g_type_check_class_is_a ((GTypeClass*) cp, gt))
#  define _XTYPE_CVH(vl, gt)             (g_type_check_value_holds ((const GValue*) vl, gt))
#endif /* !__GNUC__ */
/**
